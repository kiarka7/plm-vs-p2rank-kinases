...
OUT_JSON  = os.path.join(BASE_DIR, KINASE_FOLDER, "04.eval_all_in_one.json")

ORACLE_CHAIN_CSV   = os.path.join(BASE_DIR, KINASE_FOLDER, "04.p2rank_oracle_chain_report.csv")
ORACLE_CHAIN_JSON  = os.path.join(BASE_DIR, KINASE_FOLDER, "04.p2rank_oracle_chain_details.json")

PLM_CHAIN_CSV      = os.path.join(BASE_DIR, KINASE_FOLDER, "04.plm_chain_diagnostics.csv")
PLM_CHAIN_JSON     = os.path.join(BASE_DIR, KINASE_FOLDER, "04.plm_chain_diagnostics.json")
