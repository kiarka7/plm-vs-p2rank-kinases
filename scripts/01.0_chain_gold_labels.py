...
# ========= CONFIG =========
BASE_DIR      = "."
KINASE_FOLDER = "Kinase_Type_ALLO"  # <- adjust to your folder
EXCEL_FILE    = os.path.join(BASE_DIR, KINASE_FOLDER, "CLEAN/Allostreric Kinase LIgands Only_CLEAN.xlsx")
STRUCT_DIR    = os.path.join(BASE_DIR, KINASE_FOLDER, "structures")
OUTPUT_JSON   = os.path.join(BASE_DIR, KINASE_FOLDER, "01.chain_gold_labels_CLEAN.json")
AUDIT_CSV     = os.path.join(BASE_DIR, KINASE_FOLDER, "01.ligand_audit_CLEAN.csv")
