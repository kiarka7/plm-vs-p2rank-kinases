...
INPUT_XLSX = "Allostreric Kinase LIgands Only.xlsx" 
SHEET_NAME = 0
OUT_XLSX = "Allostreric Kinase LIgands Only_oneStructPerProtein.xlsx"
OUT_TSV  = "Allostreric Kinase LIgands Only_oneStructPerProtein.tsv"
